    ...
    return ( 
        <main>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
              ...
              >
                <p>
                  <FaBed className="inline-block mr2"/>  {property.beds} {' '}
                  <span className="hidden sm:inline">Beds</span>
                </p>
                <p>
                <FaBath className="inline-block mr2"/> {property.baths} {' '}
                  <span className="hidden sm:inline">Baths</span>
                </p>
                <p>
                <FaRulerCombined className="hidden sm:inline"/>
                {property.square_feet} {' '} <span className="hidden sm:inline">sft</span>
                </p>
              </div>
