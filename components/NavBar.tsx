    ...
    <nav className="bg-blue-700 border-b border-blue-500">
      ...
      <div className="" id="mobile-menu">
        <div className="space-y-1 px-2 pb-3 pt-2">
          ...
          <Link
            href="/properties/add"
            className={`${pathname==='/properties/add'?'bg-black':''} ${isLoggedIn?'':'hidden'} text-white block rounded-md px-3 py-2 text-base font-medium`}
          >
            Add Property
          </Link>
          <button className={`${isLoggedIn?'hidden':''} flex items-center text-white bg-gray-700 hover:bg-gray-900 hover:text-white rounded-md px-3 py-2 my-5`}>
            <FaGoogle className="text-white mr-2" />
            <span>Login or Register</span>
          </button>
        </div>
